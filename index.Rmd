...
---
maybe video demonstration of the app?

---
maybe some techincal details? e.g. showing how plotlyProxy is used for updating, how event data is used for brushing

---
class: center
## Thanks!

```{r, out.width='45%', out.height='45%', autoplay=FALSE}
